...
def periodic_pairs(grid: RectilinearGrid,
    ...
    two flat index sets differ by the constant ``(shape_nodes[axis] - 1) *
    stride[axis]``.  That identity is asserted by the module's self-test.
    """
    a = _axis_index(axis)
